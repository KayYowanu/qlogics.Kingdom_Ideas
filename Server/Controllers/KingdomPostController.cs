...
namespace qlogics.Kingdom_Ideas.Controllers
{
    ...
    public class KingdomPostController : Controller
    {
        private readonly IKingdom_IdeasRepository _Kingdom_IdeasRepository;
        private readonly ILogManager _logger;
        protected int _entityId = -1;

        public KingdomPostController(IKingdom_IdeasRepository IKingdom_IdeasRepository, ILogManager logger, IHttpContextAccessor accessor)
        {
        ...
        public void Delete(int id)
        {
            ...
            if (Kingdom_Ideas != null && Kingdom_Ideas.ModuleId == _entityId)
            {
                ...
                _logger.Log(LogLevel.Information, this, LogFunction.Delete, "Kingdom_Ideas Deleted {PostId}", id);
            }
        }
    }
}
